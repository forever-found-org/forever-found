        ...
        <div className="mt-16 font-serif px-4 sm:px-10">
            <div className="bg-white shadow-lg rounded-2xl p-8 max-w-3xl mx-auto text-center border border-gray-200">
                ...
                <h2 className="text-xl sm:text-xl text-gray-700 mb-4 leading-relaxed">
                    You can check your Adopter approval status anytime using the <br />
                    <span className="text-red-500 font-semibold">‘Adopter Approval Status’</span> <br />
                    button on the homepage.
                </h2>
                <p className="text-lg text-gray-600 italic">
                    To check your application status, simply enter your Adopter's <span className="font-semibold"> Name</span> and <span className="font-semibold">Email ID</span>.
                </p>
            </div>
