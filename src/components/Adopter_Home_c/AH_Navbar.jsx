...
function AH_Navbar(){
    return (
        <div className="h-20  p-2 pr-20 flex justify-between" style={{backgroundColor:'#006D77'}}>
            ...
            <button className="h-10 mt-3 font-serif  border border-white p-2 rounded-md text-white  hover:bg-white hover:text-black hover:font-bold capitalize" >home</button>
            ...
            <button className="h-10 mt-3 font-serif border border-white p-2 rounded-md text-white hover:border-2 capitalize hover:bg-white hover:text-black hover:font-bold" >logout</button>
        </div>
    );
}
